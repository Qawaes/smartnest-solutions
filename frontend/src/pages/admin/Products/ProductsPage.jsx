...
import { Plus, Search, Edit, Trash2, Upload, X, Tag, DollarSign, ImageIcon } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  const handleDeleteImage = async (imageId, productId) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/products/images/${imageId}`, {
        method: 'DELETE'
      });
  ...
  const openEditModal = (product) => {
    ...
    setFormData({
      ...
      price: product.price,
      category_id: categories.find(c => c.slug === product.category)?.id || '',
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none appearance-none cursor-pointer"
                  >
              ...
              {editingProduct && (
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    {productImages.length === 0 && !uploadingImages && (
              ...
              {!editingProduct && (
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <p className="text-sm text-blue-800">
                    💡 <strong>Tip:</strong> Save the product first, then you can upload images by editing it.
                  </p>
                </div>
              )}

              <div className="sticky bottom-0 bg-white border-t border-gray-100 px-0 py-4 flex gap-3">
                <button
                  type="button"
                  onClick={closeModal}
